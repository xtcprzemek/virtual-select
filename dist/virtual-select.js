 ...
 */ /******/ (function () {
  ...
  !(function () {
    ...
    function _slicedToArray(r, e) {
      return (
        ...
        dom_utils_unsupportedIterableToArray(r, e) ||
        _nonIterableRest()
      );
    }
    ...
    function dom_utils_toConsumableArray(r) {
      return (
        dom_utils_arrayWithoutHoles(r) ||
        dom_utils_iterableToArray(r) ||
        dom_utils_unsupportedIterableToArray(r) ||
        dom_utils_nonIterableSpread()
      );
    }
    ...
    function dom_utils_unsupportedIterableToArray(r, a) {
      if (r) {
        if ("string" == typeof r) return dom_utils_arrayLikeToArray(r, a);
        var t = {}.toString.call(r).slice(8, -1);
        return (
          "Object" === t && r.constructor && (t = r.constructor.name),
          "Map" === t || "Set" === t
            ...
            : "Arguments" === t ||
              /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)
            ? dom_utils_arrayLikeToArray(r, a)
            : void 0
        );
      }
    }
    function dom_utils_iterableToArray(r) {
      if (
        ("undefined" != typeof Symbol && null != r[Symbol.iterator]) ||
        null != r["@@iterator"]
      )
    ...
    function dom_utils_arrayWithoutHoles(r) {
      if (Array.isArray(r)) return dom_utils_arrayLikeToArray(r);
    }
    function dom_utils_arrayLikeToArray(r, a) {
      (null == a || a > r.length) && (a = r.length);
      for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e];
      return n;
    }
    function dom_utils_classCallCheck(a, n) {
      if (!(a instanceof n))
        throw new TypeError("Cannot call a class as a function");
    }
    function dom_utils_defineProperties(e, r) {
      for (var t = 0; t < r.length; t++) {
        var o = r[t];
        (o.enumerable = o.enumerable || !1),
          (o.configurable = !0),
          "value" in o && (o.writable = !0),
          Object.defineProperty(e, dom_utils_toPropertyKey(o.key), o);
      }
    }
    function dom_utils_createClass(e, r, t) {
      return (
        r && dom_utils_defineProperties(e.prototype, r),
        t && dom_utils_defineProperties(e, t),
        Object.defineProperty(e, "prototype", { writable: !1 }),
        e
      );
    }
    function dom_utils_toPropertyKey(t) {
      var i = dom_utils_toPrimitive(t, "string");
      return "symbol" == dom_utils_typeof(i) ? i : i + "";
    }
    function dom_utils_toPrimitive(t, r) {
      if ("object" != dom_utils_typeof(t) || !t) return t;
      var e = t[Symbol.toPrimitive];
      if (void 0 !== e) {
        var i = e.call(t, r || "default");
        if ("object" != dom_utils_typeof(i)) return i;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return ("string" === r ? String : Number)(t);
    }
          ...
          value:
            ...
            function addClass($ele, classNames) {
              ...
              DomUtils.getElements($ele).forEach(function ($this) {
                ...
                (_$this$classList = $this.classList).add.apply(
                  _$this$classList,
                  dom_utils_toConsumableArray(classNamesArr)
                );
              });
            },
        ...
        },
        {
          ...
          value: function removeClass($ele, classNames) {
            ...
            DomUtils.getElements($ele).forEach(function ($this) {
              ...
              (_$this$classList2 = $this.classList).remove.apply(
                _$this$classList2,
                dom_utils_toConsumableArray(classNamesArr)
              );
            });
        ...
        },
        {
          ...
          value: function setAttrFromEle($from, $to, attrList, valueLessProps) {
            ...
            attrList.forEach(function (attr) {
              ...
              if (
                value ||
                (valueLessProps.indexOf(attr) !== -1 && value === "")
              ) {
    ...
    function _defineProperty(e, r, t) {
      return (
        (r = virtual_select_toPropertyKey(r)) in e
    ...
    function virtual_select_typeof(o) {
      "@babel/helpers - typeof";
      return (
        (virtual_select_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (o) {
                return typeof o;
              }
        ...
        virtual_select_typeof(o)
      );
    }
    function virtual_select_slicedToArray(r, e) {
      return (
        virtual_select_arrayWithHoles(r) ||
        virtual_select_iterableToArrayLimit(r, e) ||
        virtual_select_unsupportedIterableToArray(r, e) ||
        virtual_select_nonIterableRest()
      );
    }
    ...
    function virtual_select_iterableToArrayLimit(r, l) {
      var t =
        null == r
          ? null
          : ("undefined" != typeof Symbol && r[Symbol.iterator]) ||
    ...
    function virtual_select_arrayWithHoles(r) {
      if (Array.isArray(r)) return r;
    }
    function virtual_select_toConsumableArray(r) {
      return (
        virtual_select_arrayWithoutHoles(r) ||
        virtual_select_iterableToArray(r) ||
        virtual_select_unsupportedIterableToArray(r) ||
        virtual_select_nonIterableSpread()
      );
    }
    ...
    function virtual_select_unsupportedIterableToArray(r, a) {
      if (r) {
        if ("string" == typeof r) return virtual_select_arrayLikeToArray(r, a);
        var t = {}.toString.call(r).slice(8, -1);
        return (
          "Object" === t && r.constructor && (t = r.constructor.name),
          "Map" === t || "Set" === t
            ...
            : "Arguments" === t ||
              /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)
            ? virtual_select_arrayLikeToArray(r, a)
            : void 0
        );
      }
    }
    function virtual_select_iterableToArray(r) {
      if (
        ("undefined" != typeof Symbol && null != r[Symbol.iterator]) ||
        null != r["@@iterator"]
      )
    ...
    function virtual_select_arrayWithoutHoles(r) {
      if (Array.isArray(r)) return virtual_select_arrayLikeToArray(r);
    }
    function virtual_select_arrayLikeToArray(r, a) {
      (null == a || a > r.length) && (a = r.length);
      for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e];
      return n;
    }
    function virtual_select_classCallCheck(a, n) {
      if (!(a instanceof n))
        throw new TypeError("Cannot call a class as a function");
    }
    function virtual_select_defineProperties(e, r) {
      for (var t = 0; t < r.length; t++) {
        var o = r[t];
        (o.enumerable = o.enumerable || !1),
          (o.configurable = !0),
          "value" in o && (o.writable = !0),
          Object.defineProperty(e, virtual_select_toPropertyKey(o.key), o);
      }
    }
    function virtual_select_createClass(e, r, t) {
      return (
        r && virtual_select_defineProperties(e.prototype, r),
        t && virtual_select_defineProperties(e, t),
        Object.defineProperty(e, "prototype", { writable: !1 }),
        e
      );
    }
    function virtual_select_toPropertyKey(t) {
      var i = virtual_select_toPrimitive(t, "string");
      return "symbol" == virtual_select_typeof(i) ? i : i + "";
    }
    function virtual_select_toPrimitive(t, r) {
      if ("object" != virtual_select_typeof(t) || !t) return t;
      var e = t[Symbol.toPrimitive];
      if (void 0 !== e) {
        var i = e.call(t, r || "default");
        if ("object" != virtual_select_typeof(i)) return i;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return ("string" === r ? String : Number)(t);
    }
    ...
    var VirtualSelect = /*#__PURE__*/ (function () {
      ...
      return virtual_select_createClass(
        VirtualSelect,
        [
          {
            key: "render",
            value: function render() {
              ...
              var valueTooltip = this.showValueAsTags
                ? ""
                : this.getTooltipAttrText(this.placeholder, true, true);
              var clearButtonTooltip = this.getTooltipAttrText(
                this.clearButtonText
              );
              var ariaLabelledbyText = this.ariaLabelledby
                ? 'aria-labelledby="'.concat(this.ariaLabelledby, '"')
                : "";
              var ariaLabelText = this.ariaLabelText
                ? 'aria-label="'.concat(this.ariaLabelText, '"')
                : "";
              var ariaLabelClearBtnTxt = this.ariaLabelClearButtonText
              ...
              if (this.popupPosition) {
                wrapperClasses += " popup-position-".concat(
                  this.popupPosition.toLowerCase()
                );
              }

              // eslint-disable-next-line no-trailing-spaces
              var html = '<div id="vscomp-ele-wrapper-'
                .concat(uniqueId, '" class="vscomp-ele-wrapper ')
                .concat(
                  wrapperClasses,
              ...
              this.$dropboxContainerTop = this.$dropboxContainer.querySelector(
          ...
          },
          {
            ...
            value: function renderDropbox(_ref) {
              ...
              if (this.additionalDropboxContainerClasses) {
                dropboxContainerClasses += " ".concat(
                  this.additionalDropboxContainerClasses
                );
              }

              // eslint-disable-next-line no-trailing-spaces
              var html = '<div id="vscomp-dropbox-container-'
              ...
              if ($wrapper) {
                ...
                DomUtils.addClass(
                  $dropboxWrapper,
                  "vscomp-dropbox-wrapper ".concat(wrapperClasses)
                );
                return "";
              }
            ...
            value: function renderOptions() {
              ...
              if (markSearchResults) {
                searchRegex = new RegExp(
                  "(".concat(
                    Utils.regexEscape(this.searchValue),
                    ")(?!([^<]+)?>)"
                  ),
                  "gi"
                );
              ...
              visibleOptions.forEach(function (d) {
                ...
                if (d.isGroupOption) {
                  ...
                  groupIndexText = 'data-group-index="'.concat(
                    d.groupIndex,
                    '"'
                  );
                  if (d.customData) {
                    groupName =
                      d.customData.group_name !== undefined
                        ? "".concat(d.customData.group_name, ", ")
                        : "";
                    optionDesc =
                      d.customData.description !== undefined
                        ? " ".concat(d.customData.description, ",")
                        : "";
                ...
                if (d.description) {
                  description = '<div class="vscomp-option-description" '
                    .concat(optionTooltip, ">")
                    .concat(d.description, "</div>");
                }
                if (d.isCurrentNew) {
                ...
                html += '<div role="option" aria-selected="'
                  .concat(isSelected, '" id="vscomp-option-')
                  .concat(uniqueId, "-")
                  .concat(index, '"\n          class="')
                  .concat(optionClasses, '" data-value="')
                  .concat(d.value, '" data-index="')
                  .concat(index, '" data-visible-index="')
                  .concat(d.visibleIndex, '"\n          tabindex=')
                  .concat(tabIndexValue, " ")
                  .concat(groupIndexText, " ")
                  .concat(ariaDisabledText, " ")
                  .concat(ariaLabel, "\n        >\n          ")
                  .concat(
                    leftSection,
              ...
              if (this.multiple && !this.disableSelectAll) {
                checkboxHtml =
                  '<span class="vscomp-toggle-all-button" tabindex="0" aria-label="'
                    ...
                    .concat(this.selectAllText, "</span>\n        </span>");
              }
              if (this.hasSearch) {
          ...
          },
          {
            ...
            value: function onDocumentClick(e) {
              ...
              if (
                $eleToKeepOpen !== this.$wrapper &&
                $eleToKeepOpen !== this.$dropboxWrapper &&
                this.isOpened()
              ) {
                this.closeDropbox();
              }
          ...
          },
          {
            ...
            value: function onKeyDown(e) {
              ...
              if (
                document.activeElement === this.$toggleAllButton &&
                key === 13
              ) {
            ...
            value: function addMutationObserver() {
              ...
              this.mutationObserver = new MutationObserver(function (
                ...
                mutations.forEach(function (mutation) {
                  if (!isAdded) {
                    isAdded = virtual_select_toConsumableArray(
                      mutation.addedNodes
                    ).some(function ($ele) {
                      return !!(
                        $ele === $vscompEle || $ele.contains($vscompEle)
                      );
                    });
                  }
                  if (!isRemoved) {
                    isRemoved = virtual_select_toConsumableArray(
          ...
          },
          {
            ...
            value: function afterRenderOptions() {
              ...
              if (document.activeElement !== this.$searchInput) {
                var focusedOption = DomUtils.getElementsBySelector(
                  ".focused",
                  this.$dropboxContainer
                )[0];
          ...
          },
          {
            ...
            value: function setProps(params) {
              ...
              this.searchByStartsWith = convertToBoolean(
                options.searchByStartsWith
              );
              ...
              this.hasOptionDescription = convertToBoolean(
                options.hasOptionDescription
              );
              ...
              this.markSearchResults = convertToBoolean(
                options.markSearchResults
              );
              this.showSelectedOptionsFirst = convertToBoolean(
                options.showSelectedOptionsFirst
              );
              this.disableSelectAll = convertToBoolean(
                options.disableSelectAll
              );
              this.keepAlwaysOpen = convertToBoolean(options.keepAlwaysOpen);
              this.showDropboxAsPopup = convertToBoolean(
                options.showDropboxAsPopup
              );
              this.hideValueTooltipOnSelectAll = convertToBoolean(
                options.hideValueTooltipOnSelectAll
              );
              this.showOptionsOnlyOnSearch = convertToBoolean(
                options.showOptionsOnlyOnSearch
              );
              this.selectAllOnlyVisible = convertToBoolean(
                options.selectAllOnlyVisible
              );
              this.alwaysShowSelectedOptionsCount = convertToBoolean(
                options.alwaysShowSelectedOptionsCount
              );
              this.alwaysShowSelectedOptionsLabel = convertToBoolean(
                options.alwaysShowSelectedOptionsLabel
              );
              this.disableAllOptionsSelectedText = convertToBoolean(
                options.disableAllOptionsSelectedText
              );
              this.showValueAsTags = convertToBoolean(options.showValueAsTags);
              this.disableOptionGroupCheckbox = convertToBoolean(
                options.disableOptionGroupCheckbox
              );
              this.enableSecureText = convertToBoolean(
                options.enableSecureText
              );
              this.setValueAsArray = convertToBoolean(options.setValueAsArray);
              this.disableValidation = convertToBoolean(
              ...
              this.focusSelectedOptionOnOpen = convertToBoolean(
                options.focusSelectedOptionOnOpen
              );
              ...
              this.additionalDropboxContainerClasses =
                options.additionalDropboxContainerClasses;
              this.additionalToggleButtonClasses =
                options.additionalToggleButtonClasses;
              ...
              this.initialSelectedValue =
                options.selectedValue === 0 ? "0" : options.selectedValue;
          ...
          },
          {
            ...
            value: function setValueMethod(newValue, silentChange) {
              ...
              if (isMultiSelect) {
                ...
                var _validValues2 = virtual_select_slicedToArray(
                  _validValues,
                  1
                );
          ...
          },
          {
            ...
            value: function setGroupsSelectedProp() {
              var isAllGroupOptionsSelected =
                this.isAllGroupOptionsSelected.bind(this);
              this.options.forEach(function (d) {
                if (d.isGroupTitle) {
                  // eslint-disable-next-line no-param-reassign
            ...
            value: function setOptions() {
              ...
              var _prepareOption = function prepareOption(d) {
                ...
                var option = {
                  ...
                  value: value,
                  label: label,
                  labelNormalized: _this7.searchNormalize
          ...
          },
          {
            ...
            value: function setSortedOptions() {
              var sortedOptions = virtual_select_toConsumableArray(
                this.options
              );
          ...
          },
          {
            ...
            value: function setVisibleOptions() {
              var visibleOptions = virtual_select_toConsumableArray(
                this.sortedOptions
              );
              ...
              if (newOption) {
                visibleOptions = [newOption].concat(
                  virtual_select_toConsumableArray(visibleOptions)
                );
              }
          ...
          },
          {
            ...
            value: function setOptionsPosition(startIndex) {
              ...
              var top = parseInt(
                (startIndex || this.getVisibleStartIndex()) * this.optionHeight
              );
          ...
          },
          {
            ...
            value: function setOptionsTooltip() {
              ...
              visibleOptions.forEach(function (d) {
                var $optionEle = _this9.$dropboxContainer.querySelector(
                  '.vscomp-option[data-index="'.concat(d.index, '"]')
                );
                DomUtils.setData(
          ...
          },
          {
            ...
            value: function setValue(value) {
              var _ref2 =
                ...
                disableEvent =
                  _ref2$disableEvent === void 0 ? false : _ref2$disableEvent,
                _ref2$disableValidati = _ref2.disableValidation,
                disableValidation =
                  _ref2$disableValidati === void 0
                    ? false
                    : _ref2$disableValidati;
              var isValidValue =
                (this.hasEmptyValueOption && value === "") || value;
              if (!isValidValue) {
                this.selectedValues = [];
              } else if (Array.isArray(value)) {
            ...
            value: function setValueText() {
              ...
              if (showAllText && this.hideValueTooltipOnSelectAll) {
                ...
                selectedOptions.some(function (d) {
                  ...
                  var label = d.label;
                  label = '<span class="value-label-span">' + label + "</span>"; //PS 202503
                  ...
                  if (showValueAsTags) {
                    ...
                    var valueTooltipForTags = Utils.willTextOverflow(
                      $valueText.parentElement,
                      label
                    )
                      ? _this10.getTooltipAttrText(label, false, true)
                      : "";
                    var valueTagHtml =
                ...
                if (aggregatedValueText === "") {
                  ...
                  if (multiple) {
                    var maxValues = this.maxValues;
                    var showSelectedCount =
                      this.alwaysShowSelectedOptionsCount ||
                      DomUtils.hasEllipsis($valueText);
                    if (showSelectedCount || maxValues || showValueAsTags) {
                      ...
                      if (showAllText) {
                        ...
                        this.$valueTags =
                          $valueText.querySelectorAll(".vscomp-value-tag");
                        ...
                        var optionsSelectedText =
                          selectedLength === 1
                            ? this.optionSelectedText
                            : this.optionsSelectedText;
                        $valueText.innerHTML = ""
                          .concat(countText, " ")
                          .concat(optionsSelectedText);
                      }
                    } else {
          ...
          },
          {
            ...
            value: function setVisibleOptionsCount() {
              ...
              searchValue = this.searchNormalize
          ...
          },
          {
            ...
            value: function setDropboxWrapperWidth() {
              ...
              var width =
                this.dropboxWidth || "".concat(this.$wrapper.offsetWidth, "px");
            ...
            value: function setScrollTop() {
              ...
              if (selectedOptionIndex) {
                this.$optionsContainer.scrollTop =
                  this.optionHeight * selectedOptionIndex;
              }
            },
            /** set methods - end */
            ...
            value: function getTooltipAttrText(text) {
              ...
              var allowHtml =
                arguments.length > 2 && arguments[2] !== undefined
                  ? arguments[2]
                  : false;
              var tootltipText = Utils.containsHTML(text)
                ? Utils.replaceDoubleQuotesWithHTML(text)
                : text;
              var data = {
          ...
          },
          {
            ...
            value: function getSelectedOptions() {
              var _ref3 =
                ...
                fullDetails =
                  _ref3$fullDetails === void 0 ? false : _ref3$fullDetails,
                _ref3$keepSelectionOr = _ref3.keepSelectionOrder,
                keepSelectionOrder =
                  _ref3$keepSelectionOr === void 0
                    ? false
                    : _ref3$keepSelectionOr;
              var valueKey = this.valueKey,
                labelKey = this.labelKey,
                selectedValues = this.selectedValues;
              var selectedOptions = [];
                ...
                if (d.isSelected && !d.isGroupTitle) {
                  if (fullDetails) {
                    ...
                    var data = _defineProperty(
                      _defineProperty({}, valueKey, d.value),
                      labelKey,
                      d.label
                    );
                    if (d.isNew) {
              ...
              return this.multiple || fullDetails
                ? selectedOptions
                : selectedOptions[0];
            },
          },
            ...
            value: function getDisabledOptions() {
              ...
              this.options.forEach(function (_ref4) {
                ...
                if (disabledOptionsValueMapping[value]) {
                  result.push(
                    _defineProperty(
                      _defineProperty({}, valueKey, value),
                      labelKey,
                      label
                    )
                  );
          ...
          },
          {
            ...
            value: function getSibling($ele, direction) {
              ...
              do {
                ...
                DomUtils.hasClass($sibling, "disabled") ||
                DomUtils.hasClass($sibling, "group-title")
              );
              return $sibling;
            },
          },
          {
            ...
            value: function getUniqueId() {
              ...
              var isAlreadyUsed = document.querySelector(
                "#vscomp-ele-wrapper-".concat(uniqueId)
              );
              if (isAlreadyUsed) {
          ...
          },
          {
            ...
            value: function focusElementOnOpen() {
              ...
              if ($ele) {
                ...
                var $focusableEle =
                  this.$dropbox.querySelector('[tabindex="0"]');
          ...
          },
          {
            ...
            value: function focusFirstVisibleOption() {
              var $focusableEle = this.$optionsContainer.querySelector(
          ...
          },
          {
            ...
            value: function focusOption() {
              ...
              var $focusedEle = this.$dropboxContainer.querySelector(
              ...
              if ($newFocusedEle && $newFocusedEle !== $focusedEle) {
                ...
                this.toggleFocusedProp(
                  DomUtils.getData($newFocusedEle, "index"),
                  true
                );
          ...
          },
          {
            ...
            value: function selectRangeOptions(
              lastSelectedOptionIndex,
              selectedIndex
            ) {
              var _this11 = this;
              if (
                typeof lastSelectedOptionIndex !== "number" ||
                this.maxValues
              ) {
                return;
              }
            ...
            value: function toggleAllOptions(selectAll) {
              ...
              var selectingAll =
                typeof isSelected === "boolean"
                  ? selectAll
                  : !DomUtils.hasClass(this.$toggleAllCheckbox, "checked");
              var selectedValues = [];
              ...
              this.options.forEach(function (d) {
                ...
                if (
                  ...
                  (!selectingAll &&
                    (!selectAllOnlyVisible ||
                      isVisible ||
                      !isSelected)) /** when selecting all, selectAllOnlyVisible feature enabled and hidden items those are not already selected */ ||
                  (selectingAll &&
                    selectAllOnlyVisible &&
                    !isVisible &&
                    !isSelected)
          ...
          },
          {
            ...
            value: function toggleGroupOptionsParent($option, isSelected) {
              ...
              var $group = this.$options.querySelector(
                '.vscomp-option[data-index="'.concat(groupIndex, '"]')
              );
              var isAllSelected =
                typeof isSelected === "boolean"
                  ? isSelected
                  : this.isAllGroupOptionsSelected(groupIndex);
          ...
          },
          {
            ...
            value: function addOption(data, rerender) {
              ...
              var newOption = this.getOptionObj(
                _objectSpread(
                  _objectSpread({}, data),
                  {},
                  {
          ...
          },
          {
            ...
            value: function isOptionVisible(_ref7) {
              ...
              var label = this.searchNormalize
                ? data.labelNormalized
                : data.label.toLowerCase();
              var description = data.description,
                alias = data.alias;
              var isVisible = searchByStartsWith
                ? label.startsWith(searchValue)
        ...
        [
          {
            ...
            value: function init(options) {
              ...
              if (
                $eleArray.length === undefined ||
                $eleArray.forEach === undefined
              ) {
                $eleArray = [$eleArray];
                singleEle = true;
              }
          ...
          },
          {
            ...
            value: function setPropsFromSelect(props) {
              ...
              DomUtils.setAttrFromEle(
                $ele,
                $newEle,
                Object.keys(attrPropsMapping),
                valueLessProps
              );
          ...
          },
          {
            ...
            value: function setValueMethod() {
              ...
              (_this$virtualSelect = this.virtualSelect).setValueMethod.apply(
                _this$virtualSelect,
                arguments
              );
            },
          },
          {
            ...
            value: function setOptionsMethod() {
              ...
              (_this$virtualSelect2 =
                this.virtualSelect).setOptionsMethod.apply(
                _this$virtualSelect2,
                arguments
              );
            },
          },
          {
            ...
            value: function setDisabledOptionsMethod() {
              ...
              (_this$virtualSelect3 =
                this.virtualSelect).setDisabledOptionsMethod.apply(
                _this$virtualSelect3,
                arguments
              );
            },
          },
          {
            ...
            value: function setEnabledOptionsMethod() {
              ...
              (_this$virtualSelect4 =
                this.virtualSelect).setEnabledOptionsMethod.apply(
                _this$virtualSelect4,
                arguments
              );
            },
  ...
  !(function () {
     ...
     */ !(function () {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var t = e.getBoundingClientRect(),
                  ...
                  n = t.top;
                return {
                  horizontal: r > o - r - t.width ? "left" : "right",
      ...
      var n = ["top", "bottom", "left", "right"].map(function (e) {
            ...
            (o = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var z = {
                      top: { top: S - h - A, left: D + O },
                      bottom: { top: S + m + A, left: D + O },
                      right: { top: S + T, left: D + y + A },
                      left: { top: S + T, left: D - p - A },
                    },
                    F = z[C];
                  if (
                    ((S = F.top),
                  ...
                  if (
                    (i.setStyle(this.$popperEle, "transform", U),
                    i.setData(this.$popperEle, "fromLeft", t),
                    i.setData(this.$popperEle, "fromTop", e),
                    i.setData(this.$popperEle, "top", S),
                    i.setData(this.$popperEle, "left", D),
                    i.removeClass(this.$popperEle, n.join(" ")),
                    ...
                    (this.exitDelayTimeout = setTimeout(function () {
                      if (e.$popperEle) {
                        var o = parseInt(i.getData(e.$popperEle, "fromLeft")),
                          r = parseInt(i.getData(e.$popperEle, "fromTop")),
                          n = "translate3d("
                            .concat(o, "px, ")
                            .concat(r, "px, 0)"),
                          a = e.hideDuration;
          ...
          return (
            ...
            (r = [
              ...
              },
              {
                ...
                value: function (t, o, r, n) {
                  t &&
                    (o = i.removeArrayEmpty(o.split(" "))).forEach(function (
                      o
                    ) {
                    ...
                    if (o) {
                      ...
                      return (
                        o.forEach(function (o) {
                          (t.ele = o), e.destroy(o), r.push(new e(t));
                        }),
                        i ? r[0] : r
                      );
                    }
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t = this,
                      ...
                      s = e.throttle;
                    r &&
                      (n = i.removeArrayEmpty(n.split(" "))).forEach(function (
                        e
                      ) {
                        var n = "".concat(a, "-").concat(e),
                          l = t.events[n];
                        l ||
                          ((l = t[a].bind(t)),
                          s && (l = i.throttle(l, s)),
